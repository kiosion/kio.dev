...
// Query: *[_type == 'project' && (_id == '$id' || slug.current == '$slug')]{  _id,  'objectID': _id,  _rev,  _type,  _createdAt,  title,  publishedAt,  tags[]->{    _id,    title,    slug  },  slug,  body,  desc,  'date': coalesce(date, _createdAt),  images,  github,  'views': coalesce(views, 0),  'numberOfCharacters': length(pt::text(body)),  'estimatedWordCount': round(length(pt::text(body)) / 5),  'estimatedReadingTime': round(length(pt::text(body)) / 5 / 120)}[0]
...
// Query: *[_type == 'project']{  _id,  'objectID': _id,  _rev,  _type,  _createdAt,  title,  publishedAt,  tags[]->{    _id,    title,    slug  },  slug,  body,  desc,  'date': coalesce(date, _createdAt),  images,  github,  'views': coalesce(views, 0),  'numberOfCharacters': length(pt::text(body)),  'estimatedWordCount': round(length(pt::text(body)) / 5),  'estimatedReadingTime': round(length(pt::text(body)) / 5 / 120)} | order($sortOrder) [$startNumber...$endNumber]
...
// Variable: CountProjectsQuery
// Query: count(*[_type == 'project'])
export type CountProjectsQueryResult = number;
...
declare module '@sanity/client' {
  interface SanityQueries {
    ...
    "*[_type == 'project' && (_id == '$id' || slug.current == '$slug')]{\n  _id,\n  'objectID': _id,\n  _rev,\n  _type,\n  _createdAt,\n  title,\n  publishedAt,\n  tags[]->{\n    _id,\n    title,\n    slug\n  },\n  slug,\n  body,\n  desc,\n  'date': coalesce(date, _createdAt),\n  images,\n  github,\n  'views': coalesce(views, 0),\n  'numberOfCharacters': length(pt::text(body)),\n  'estimatedWordCount': round(length(pt::text(body)) / 5),\n  'estimatedReadingTime': round(length(pt::text(body)) / 5 / 120)\n}[0]": GetProjectQueryResult;
    "*[_type == 'post']{\n  _id,\n  'objectID': _id,\n  _rev,\n  _type,\n  _createdAt,\n  title,\n  publishedAt,\n  tags[]->{\n    _id,\n    title,\n    slug\n  },\n  slug,\n  body,\n  desc,\n  'date': coalesce(date, _createdAt),\n  'views': coalesce(views, 0),\n  'numberOfCharacters': length(pt::text(body)),\n  'estimatedWordCount': round(length(pt::text(body)) / 5),\n  'estimatedReadingTime': round(length(pt::text(body)) / 5 / 120)\n} | order($sortOrder) [$startNumber...$endNumber]": GetPostsQueryResult;
    "count(*[_type == 'post'])": CountPostsQueryResult;
    "*[_type == 'project']{\n  _id,\n  'objectID': _id,\n  _rev,\n  _type,\n  _createdAt,\n  title,\n  publishedAt,\n  tags[]->{\n    _id,\n    title,\n    slug\n  },\n  slug,\n  body,\n  desc,\n  'date': coalesce(date, _createdAt),\n  images,\n  github,\n  'views': coalesce(views, 0),\n  'numberOfCharacters': length(pt::text(body)),\n  'estimatedWordCount': round(length(pt::text(body)) / 5),\n  'estimatedReadingTime': round(length(pt::text(body)) / 5 / 120)\n} | order($sortOrder) [$startNumber...$endNumber]": GetProjectsQueryResult;
    "count(*[_type == 'project'])": CountProjectsQueryResult;
  }
}
