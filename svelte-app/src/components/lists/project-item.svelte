...
<Hoverable bind:hovered>
  <a
    class="relative flex w-full flex-col items-stretch justify-start gap-y-1.5 rounded-xl py-5 px-6 transition-colors lg:w-[calc(50%_-_12px)] 3xl:w-[calc(50%_-_12px)] {hovered
