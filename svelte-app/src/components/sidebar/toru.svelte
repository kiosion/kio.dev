...
{#if data}
  <div
    class="relative order-4 flex select-none flex-row items-center justify-start gap-4 rounded-xl bg-neutral-100 p-3 dark:bg-neutral-600"
    in:blur={blurInOpts}
  ...
  >
    <div class="relative flex-shrink-0 overflow-clip">
      ...
      {#if data.playing}
        <div
          class="absolute left-0 top-0 aspect-square h-full w-full rounded-lg bg-neutral-700/30 transition-colors dark:bg-neutral-700/50"
        ></div>
