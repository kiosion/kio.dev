...
<header class="flex flex-row flex-wrap items-center justify-between gap-y-3 font-mono">
  <nav
  ...
  <div
    class="flex flex-row items-center justify-end gap-5 pr-1.5 pt-0.5 text-dark/80 dark:text-light/80"
