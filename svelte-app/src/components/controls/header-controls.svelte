...
<Breakpoints queries={DEFAULT_BREAKPOINTS}>
  <svelte:fragment slot="lg">
    <div
      class="fixed top-0 left-40 xl:left-60 right-0 z-[5] hidden md:block rounded-tl-3xl py-6 px-8 bg-slate-100/80 dark:bg-slate-800/80 transition-colors backdrop-blur-md"
    >
