...
<svelte:element
  ...
  class="focus-outline-sm group flex cursor-pointer flex-row items-center justify-center gap-2 rounded-lg bg-neutral-200/50 px-2.5 py-2 text-sm whitespace-nowrap transition-colors select-none hover:bg-neutral-200 focus-visible:bg-neutral-200 disabled:cursor-not-allowed dark:bg-neutral-700 dark:hover:bg-neutral-800 dark:focus-visible:bg-neutral-800 {$$props.class ??
    ''}"
