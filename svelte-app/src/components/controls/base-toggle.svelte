...
<button
  class="focus-outline group flex flex-1 cursor-pointer flex-row items-center justify-center gap-x-3 rounded-lg bg-neutral-200/50 px-4 py-2.5 text-center text-sm text-neutral-800 transition-colors hover:bg-neutral-200 focus-visible:bg-neutral-200 dark:bg-neutral-700 dark:text-neutral-100 dark:hover:bg-neutral-800 dark:focus-visible:bg-neutral-800"
  tabindex="0"
