...
<div class="flex flex-col gap-5" data-test-id="error-page">
  <BaseContainer class="flex flex-row items-center justify-end gap-3 p-2">
    ...
    <Hoverable let:hovered>
      <button
        class="focus-outline flex w-fit flex-row items-center justify-center gap-x-2 rounded-lg bg-neutral-0/75 px-2.5 py-2 text-sm transition-colors hover:bg-neutral-0 focus-visible:gap-3 focus-visible:bg-neutral-0 dark:bg-neutral-800/75 dark:hover:bg-neutral-800 dark:focus-visible:bg-neutral-800"
  ...
  <BaseContainer class="p-5">
    ...
    {#if causes?.length}
      <Hoverable let:hovered>
        <button
          class="focus-outline mt-8 flex w-fit flex-row items-center justify-center gap-x-1.5 rounded-lg bg-neutral-0/75 px-2.5 py-2 text-sm transition-colors hover:bg-neutral-0 focus-visible:gap-3 focus-visible:bg-neutral-0 dark:bg-neutral-800/75 dark:hover:bg-neutral-800 dark:focus-visible:bg-neutral-800"
